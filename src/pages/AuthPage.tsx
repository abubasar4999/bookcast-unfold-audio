...
const AuthPage = () => {
  ...
  const handlePhoneAuth = async () => {
    // For now, show a coming soon message - phone auth requires additional setup
        ...
        {isLogin && (
          <div className="mt-6">
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="w-full mt-4 border-gray-600 bg-gray-800 text-white hover:bg-gray-700 font-semibold py-4 rounded-full"
            >
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
